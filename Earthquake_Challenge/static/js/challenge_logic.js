...
// We create a third tile layer for the challenge
...
// 1. Add a 2nd layer group for the tectonic plate data and a 3rd for the major earthquake data.
let allEarthquakes = new L.LayerGroup();
let tectonicPlate = new L.LayerGroup();
let majorEarthquake = new L.LayerGroup();

// 2. Add a reference to the tectonic plates group and the major earthquake data group to the overlays object.
let overlays = {
  "Earthquakes": allEarthquakes,
  "Tectonic Plates": tectonicPlate,
  "Major Earthquake Data": majorEarthquake
};
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
    console.log(data);
    L.geoJSON(data).addTo(tectonicPlate);
    style: techtonicStyle,
